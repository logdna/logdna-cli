...
const devLogPrim = function(opts) {
    const {
        message = '' // Message to be displayed in LogDNA LiveTail. Additional fields/objects will be stored, searchable and actionable
        ...
        , when = new Date().toISOString() // When this occured in your system. Can be different then the time of the log itself
        , additional = {} // Additional fields to include in the log. An object is required
    } = opts;
