...
function LDWebSocket(address, protocols, options) {
    ...
    this.reconnectionDelay = options.reconnectionDelay || config.WS_RECONNECTION_DELAY;
    this.reconnectionDelayMax = options.reconnectionDelayMax || config.WS_RECONNECTION_DELAY_MAX;
    this.connectTimeout = options.connectTimeout || config.WS_CONNECT_TIMEOUT;
    this.connectAttempt = 0;
    this.connected = false;
    this.reconnectionFactor = config.WS_RECONNECTION_FACTOR;
