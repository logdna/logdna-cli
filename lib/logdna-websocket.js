...
function LDWebSocket(address, protocols, options) {
    ...
    this.reconnectionDelay = options.reconnectionDelay || config.WS.DELAY;
    this.reconnectionDelayMax = options.reconnectionDelayMax || config.WS.DELAY_MAX;
    this.connectTimeout = options.connectTimeout || config.WS.TIMEOUT;
    this.connectAttempt = 0;
    this.connected = false;
    this.reconnectionFactor = config.WS.FACTOR;
